...
uint8_t SH1106_Init(I2C_HandleTypeDef* I2Cx)
{
    if (I2Cx == NULL)
    {
        return 0;
...
void SH1106_DrawTriangle(
    uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t x3, uint16_t y3, SH1106_COLOR_t color)
{
    /* Draw lines */
...
void SH1106_DrawFilledTriangle(
    uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t x3, uint16_t y3, SH1106_COLOR_t color)
{
